                ...
                if (b >= 0 && b < 0.3) {
                    ...
                    switch (randomNumber) {
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            armor = new Armor("leather_armor", "torso", 2, true, true, this.getMaxX(), this.getMaxY(), this.getMaxX() + 64, this.getMaxY() + 64, 10);
                            break;
                        case 11:
                            armor = new Armor("chain_jacket_purple", "torso", 4, true, true, this.getMaxX(), this.getMaxY(), this.getMaxX() + 64, this.getMaxY() + 64, 10);
                            break;
                        case 12:
                            armor = new Armor("chain_armor", "torso", 4, true, true, this.getMaxX(), this.getMaxY(), this.getMaxX() + 64, this.getMaxY() + 64, 10);
                            break;
                        case 13:
                            armor = new Armor("plate_armor", "torso", 5, true, true, this.getMaxX(), this.getMaxY(), this.getMaxX() + 64, this.getMaxY() + 64, 10);
                            break;
                        case 14:
